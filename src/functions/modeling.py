        ...
        for model_name, model in models.items():
            ...
            if model_name in param_grid:
                ...
                random_search = RandomizedSearchCV(
                    model, param_distributions=param_dist, n_iter=10, cv=5, n_jobs=-1, random_state=42, scoring=make_scorer(f1_score)
                )
            ...
            # Cross-validation
            scores = cross_val_score(best_estimator, X_train, y_train, cv=5, scoring=make_scorer(f1_score))
